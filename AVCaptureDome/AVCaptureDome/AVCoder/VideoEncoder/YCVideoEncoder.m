...
//    NSLog(@"解码后  == %@",CMSampleBufferGetDataBuffer(sampleBuffer));
    YCVideoEncoder *encoder = (__bridge YCVideoEncoder *)(outputCallbackRefCon);
